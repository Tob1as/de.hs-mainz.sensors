...
public class Variables {
	...
	private String filepath = ""; // set to "sensorsdata/" when use docker with volume
	private File filenameXML = new File(filepath+"sensors.xml"), filenameSQLite = new File(filepath+"sensors.sqlite"), filenameConfig = new File(filepath+"config.xml");
